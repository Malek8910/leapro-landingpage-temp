...
import ProductTemplate1TypeWriterText from "./ProductTemplate1TypeWriterText";
import ProductTemplate1CoverVideo from "./ProductTemplate1CoverVideo";
...
const ProductTemplate1Home = ({ title, title1, subTitle, homeImg, homeImg_ar, guaranteeApp }) => {
...
`;
  ...
  return (
    ...
    >
      <Container>
        <Box>
          <ProductTemplate1TypeWriterText title={title} title1={title1} subTitle={subTitle} guaranteeApp={guaranteeApp} />
        </Box>
        <ProductTemplate1CoverVideo homeImg={homeImg} homeImg_ar={homeImg_ar} />
...
export default ProductTemplate1Home;
