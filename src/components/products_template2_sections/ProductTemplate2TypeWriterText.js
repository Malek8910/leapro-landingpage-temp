...
const ProductTemplate2TypeWriterText = ({ title, title2, title1 }) => {
  ...
  return (
    <Container>
      ...
      {/* <SubTitle>
        ...
        Manage and issue your bank guarantees from the comfort of your phone.
...
export default ProductTemplate2TypeWriterText;
