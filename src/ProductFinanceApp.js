...
import homeImg from "./assets/financeApp.png";
import homeImg_ar from "./assets/financeApp.png";
...
function ProductFinanceApp() {
  ...
  const features = [
    {
      ...
      title: intl.formatMessage({ id: "product.finance.app.feature1.title" }),
      details: intl.formatMessage({ id: "product.finance.app.feature1.details" }),
    },
    {
      svg: (
      ...
      title: intl.formatMessage({ id: "product.finance.app.feature2.title" }),
      details: intl.formatMessage({ id: "product.finance.app.feature2.details" }),
    },
    {
      svg: (
      ...
      title: intl.formatMessage({ id: "product.finance.app.feature3.title" }),
      details: intl.formatMessage({ id: "product.finance.app.feature3.details" }),
    },
  ];

  const steps = [
    {
      name: intl.formatMessage({ id: "product.finance.app.step1.name" }),
      name1: intl.formatMessage({ id: "product.finance.app.step1.name1" }),
      text: intl.formatMessage({ id: "product.finance.app.step1.text" }),
      icon: (
    ...
    {
      name: intl.formatMessage({ id: "product.finance.app.step2.name" }),
      name1: intl.formatMessage({ id: "product.finance.app.step2.name1" }),
      text: intl.formatMessage({ id: "product.finance.app.step2.text" }),
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1F366B">
    ...
    {
      name: intl.formatMessage({ id: "product.finance.app.step3.name" }),
      name1: intl.formatMessage({ id: "product.finance.app.step3.name1" }),
      text: intl.formatMessage({ id: "product.finance.app.step3.text" }),
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1F366B">
  ...
  const faqTitle = intl.formatMessage({ id: "product.finance.app.faq.title" });
  const faqData = [
    {
      question: intl.formatMessage({ id: "product.finance.app.faq.question1" }),
      answer: intl.formatMessage({ id: "product.finance.app.faq.answer1" }),
    },
    {
      question: intl.formatMessage({ id: "product.finance.app.faq.question2" }),
      answer: intl.formatMessage({ id: "product.finance.app.faq.answer2" }),
    },
    {
      question: intl.formatMessage({ id: "product.finance.app.faq.question3" }),
      answer: intl.formatMessage({ id: "product.finance.app.faq.answer3" }),
    },
    {
      question: intl.formatMessage({ id: "product.finance.app.faq.question4" }),
      answer: intl.formatMessage({ id: "product.finance.app.faq.answer4" }),
    },
    {
      question: intl.formatMessage({ id: "product.finance.app.faq.question5" }),
      answer: intl.formatMessage({ id: "product.finance.app.faq.answer5" }),
    },
  ];

  const stepsTitle = intl.formatMessage({ id: "product.finance.app.steps.title" });


  const title = intl.formatMessage({ id: "app.products.financeApp" });
  const title1 = intl.formatMessage({ id: "product.finance.app.title1" });
  const subTitle = intl.formatMessage({ id: "product.finance.app.subTitle" });
  
  const featuresTitle = intl.formatMessage({ id: "product.finance.app.featuresTitle" });

  const title3 = intl.formatMessage({ id: "product.finance.app.title3" });
