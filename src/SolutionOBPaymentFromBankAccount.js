...
import homeImg from "./assets/solution-ob-payment-from-bank-account.png";
import homeImg_ar from "./assets/solution-ob-payment-from-bank-account.png";
...
function SolutionOBPaymentFromBankAccount() {
  const intl = useIntl();
  ...
  const features = [
    {
      ...
      name: intl.formatMessage({ id: "ob.payment.feature1.name" }),
      text: intl.formatMessage({ id: "ob.payment.feature1.text" })
    },
    {
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0693E3">
      ...
      name: intl.formatMessage({ id: "ob.payment.feature2.name" }),
      text: intl.formatMessage({ id: "ob.payment.feature2.text" })
    },
    {
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0693E3">
      ...
      name: intl.formatMessage({ id: "ob.payment.feature3.name" }),
      text: intl.formatMessage({ id: "ob.payment.feature3.text" })
    },
    {
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0693E3">
      ...
      name: intl.formatMessage({ id: "ob.payment.feature4.name" }),
      text: intl.formatMessage({ id: "ob.payment.feature4.text" })
    }
  ];
  ...
  return (
    <Section>
      <SolutionTemplate1Home 
        upTitle={intl.formatMessage({ id: "ob.payment.upTitle" })} 
        title={intl.formatMessage({ id: "app.solutions.paymentFromBankAccount" })} 
        subTitle={intl.formatMessage({ id: "ob.payment.subTitle" })} 
        homeImg={homeImg}
        homeImg_ar={homeImg_ar}
      />
      <SolutionTemplate1Pitch 
        name1={intl.formatMessage({ id: "ob.payment.problem.name" })} 
        text1={<><p>{intl.formatMessage({ id: "ob.payment.problem.text1" })}</p></>}

        name2={intl.formatMessage({ id: "ob.payment.solution.name" })} 
        text2={<><p>{intl.formatMessage({ id: "ob.payment.solution.text1" })}</p>
          <ul>
            <li>{intl.formatMessage({ id: "ob.payment.solution.feature1" })}</li>
            <li>{intl.formatMessage({ id: "ob.payment.solution.feature2" })}</li>
            <li>{intl.formatMessage({ id: "ob.payment.solution.feature3" })}</li>
          </ul>
        </>}
      />
      <SolutionTemplate1Features features={features} />
      <SolutionTemplate1Statement 
        title={<><p>{intl.formatMessage({ id: "ob.payment.statement.text" })}</p></>}
        href=""
        showButton={false}
      />
      <SeeIt />
...
export default SolutionOBPaymentFromBankAccount;
