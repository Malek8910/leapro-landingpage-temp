...
import homeImg from "./assets/service-b2b-api-gateway.png";
import homeImg_ar from "./assets/service-b2b-api-gateway.png";
...
function SolutionB2BAPIGateway() {
  const intl = useIntl();
  ...
  const features = [
    {
      ...
      name: intl.formatMessage({ id: "b2b.api.gateway.features.enhanceEfficiency.name" }),
      text: intl.formatMessage({ id: "b2b.api.gateway.features.enhanceEfficiency.text" })
    },
    {
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0693E3">
      ...
      name: intl.formatMessage({ id: "b2b.api.gateway.features.avoidRisk.name" }),
      text: intl.formatMessage({ id: "b2b.api.gateway.features.avoidRisk.text" })
    },
    {
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0693E3">
      ...
      name: intl.formatMessage({ id: "b2b.api.gateway.features.matchNeeds.name" }),
      text: intl.formatMessage({ id: "b2b.api.gateway.features.matchNeeds.text" })
    },
    {
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#0693E3">
      ...
      name: intl.formatMessage({ id: "b2b.api.gateway.features.costSaving.name" }),
      text: intl.formatMessage({ id: "b2b.api.gateway.features.costSaving.text" })
    }
  ];
  ...
  return (
    <Section>
      <SolutionTemplate1Home 
        ...
        title={intl.formatMessage({ id: "app.solutions.b2bApiGateway" })} 
        subTitle={intl.formatMessage({ id: "b2b.api.gateway.home.subTitle" })} 
        homeImg={homeImg}
        homeImg_ar={homeImg_ar}
      />
      <SolutionTemplate1Pitch 
        name1={intl.formatMessage({ id: "b2b.api.gateway.pitch.name1" })} 
        text1={intl.formatMessage({ id: "b2b.api.gateway.pitch.text1" })} 
        name2={intl.formatMessage({ id: "b2b.api.gateway.pitch.name2" })} 
        text2={<><p>{intl.formatMessage({ id: "b2b.api.gateway.pitch.text2.part1" })}</p>
        <p>{intl.formatMessage({ id: "b2b.api.gateway.pitch.text2.part2" })}</p></>}
      />
      <SolutionTemplate1Features features={features} />
      <SolutionTemplate1Statement 
        title={intl.formatMessage({ id: "b2b.api.gateway.statement.title" })} 
        href="https://www.canva.com/design/DAGQGAy6HI0/If2W_6-iULKIPROugXqWZQ/view?utm_content=DAGQGAy6HI0&utm_campaign=designshare&utm_medium=link&utm_source=editor"
        showButton={true}
      />
      <SeeIt />
...
export default SolutionB2BAPIGateway;
